...
STAGE1="$SCAFFOLD lib/trust/types.ts lib/trust/state-machines.ts lib/trust/projections.ts lib/trust/events.ts lib/trust/prior-hash.ts lib/trust/compatibility.ts lib/trust/fixtures.ts lib/trust/index.stage1.ts tests/trust-domain.test.ts"
