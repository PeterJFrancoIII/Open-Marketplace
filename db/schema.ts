...
export const conversations = sqliteTable(
  "conversations",
  {
    ...
    shippedItemJson: text("shipped_item_json"),
    ...
    evidenceArchivedAt: text("evidence_archived_at"),
...
export const conversationMedia = sqliteTable(
  "conversation_media",
  {
    ...
    quality: text("quality").notNull().default("full"),
    width: integer("width"),
    height: integer("height"),
    createdAt: text("created_at").notNull().default(sql`CURRENT_TIMESTAMP`),
  },
  (table) => [
    uniqueIndex("conversation_media_kind_slot_idx").on(
