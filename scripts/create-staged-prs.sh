...
STAGE2="$STAGE1 lib/trust/index.ts lib/trust/transactions.ts lib/trust/auth.ts lib/trust/session.ts lib/trust/errors.ts lib/trust/rate-limit.ts lib/trust/idempotency.ts lib/trust/schemas.ts lib/trust/prior-hash.ts app/api/auth app/api/transactions tests/transaction-lifecycle.test.ts"
STAGE3="$STAGE2 lib/trust/reviews.ts lib/trust/persist-event.ts lib/trust/signed-events.ts lib/trust/projection-provenance.ts lib/trust/rebuild-projections.ts lib/trust/portable app/api/reviews tests/double-blind-reviews.test.ts tests/merge-gate-remediation.test.ts tests/d1-adversarial.test.ts"
STAGE4="$STAGE3 lib/trust/trust-card-model.ts tests/trust-card.test.ts"
